...
<template>
    <Head title="Company  Memos" />
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Company  Memos</h2>
        </div>
        </template>
                    ...
                    <table class="min-w-full divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-50 dark:divide-gray-700">
                            ...
                            <tr v-if="memos.length === 0">
                                <td colspan="5" class="px-6 py-12 text-center text-gray-400">No {{ status === 'all' ? '' : status }} meeting memos found.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
