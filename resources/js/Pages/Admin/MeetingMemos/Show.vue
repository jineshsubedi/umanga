    ...
    <AuthenticatedLayout>
        ...
        <div class="py-8">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                <!-- Memo Detail -->
                 <div class="flex items-center gap-3">
                    <a v-if="memo.status === 'approved'" :href="route('admin.meeting-memos.pdf', memo.id)" class="inline-flex items-center gap-2 bg-gray-600 hover:bg-gray-700 text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors">
