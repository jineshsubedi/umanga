                    ...
                    <div class="lg:w-auto flex-shrink-0">
                        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700 flex flex-wrap gap-x-4 gap-y-2 text-xs text-gray-500 dark:text-gray-400">
                                ...
                                <div class="flex items-center gap-1.5">
                                    <span class="inline-block w-2.5 h-2.5 rounded-full bg-yellow-400"></span> Pending Minute
                                </div>
                                <div class="flex items-center gap-1.5">
                                    <span class="inline-block w-2.5 h-2.5 rounded-full bg-blue-500"></span> Approved Minute
                                </div>
                                <div class="flex items-center gap-1.5">
                                    <span class="inline-block w-2.5 h-2.5 rounded-full bg-red-400"></span> Rejected Minute
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden h-full">
                            ...
                            <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
                                <div>
                                    ...
                                    <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100 mt-0.5">
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <div v-if="selectedMinutes.length > 0" class="space-y-3">
                                        <div v-for="minute in selectedMinutes" :key="minute.id"
                                            ...
                                            :class="{
                                                ...
                                                'bg-gray-50 dark:bg-gray-700/30 border-gray-200 dark:border-gray-700': minute.status === 'draft',
                                            }">
                                    ...
                                    <div v-else class="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-700/30 rounded-xl border border-gray-100 dark:border-gray-700">
                                        <span class="text-sm text-gray-500 dark:text-gray-400">No meeting minutes for this day.</span>
                                    </div>
                                </div>
