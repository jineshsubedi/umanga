                    ...
                    <div class="lg:w-auto flex-shrink-0">
                        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700 flex flex-wrap gap-x-4 gap-y-2 text-xs text-gray-500 dark:text-gray-400">
                                ...
                                <div class="flex items-center gap-1.5">
                                    <span class="inline-block w-2.5 h-2.5 rounded-full bg-yellow-400"></span> Pending Memo
                                </div>
                                <div class="flex items-center gap-1.5">
                                    <span class="inline-block w-2.5 h-2.5 rounded-full bg-blue-500"></span> Approved Memo
                                </div>
                                <div class="flex items-center gap-1.5">
                                    <span class="inline-block w-2.5 h-2.5 rounded-full bg-red-400"></span> Rejected Memo
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div v-if="selectedMemos.length > 0" class="space-y-3">
                                        <div v-for="memo in selectedMemos" :key="memo.id"
                                            ...
                                            :class="{
                                                ...
                                                'bg-gray-50 dark:bg-gray-700/30 border-gray-200 dark:border-gray-700': memo.status === 'draft',
                                            }">
