            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
                        ...
                        <p class="text-3xl font-bold text-gray-900">{{ stats.inactive_companies }}</p>
                        <p class="text-sm text-gray-500 font-medium mt-1">Inactive Companies</p>
                    </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
                        ...
                        <p class="text-sm text-gray-500 font-medium mt-1">Active Users</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
                        ...
                        <p class="text-3xl font-bold text-gray-900">{{ stats.admins_count }}</p>
                        <p class="text-sm text-gray-500 font-medium mt-1">Company Admins</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
                        ...
                        <p class="text-3xl font-bold text-gray-900">{{ stats.managers_count }} / {{ stats.clients_count }}</p>
                        <p class="text-sm text-gray-500 font-medium mt-1">Managers / Clients</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-gray-900">{{ stats.clocked_in_now }}</p>
