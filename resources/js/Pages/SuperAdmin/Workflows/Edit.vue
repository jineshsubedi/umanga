...
const form = useForm({
    ...
    module: props.workflow.module,
    name: props.workflow.name,
    description: props.workflow.description,
    steps: props.workflow.steps.length > 0 ? props.workflow.steps.map(s => ({
...
const submit = () => {
    form.put(route('super-admin.workflows.update', props.workflow.id));
};
</script>
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Workflow: {{ workflow.name }}</h2>
        </template>
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" v-model="form.name" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
